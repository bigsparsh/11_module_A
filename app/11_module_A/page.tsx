...
const Index = () => {
    ...
    return <div className="grid grid-cols-3 px-10 m-0 w-screen *:text-white bg-emerald-900" >
        <Link href={""} className="flex flex-col w-[300px] h-[550px] justify-center items-center gap-3 border border-emerald-100 rounded-xl">
<img src={a1_mock.src} />
<h1 className="font-bold">Module A1
</h1>
        </Link>
        <Link className="flex flex-col w-[300px] h-[550px] justify-center items-center gap-3 border border-emerald-100 rounded-xl">
<img src={a2_mock.src} />
